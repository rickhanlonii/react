...
describe('ReactFresh', () => {
  ...
  it.skip('can remount when change function to memo', async () => {
    if (__DEV__) {
      await act(async () => {
        await render(() => {
          function Test() {
  ...
  it.skip('can remount when change memo to forwardRef', async () => {
    if (__DEV__) {
      await act(async () => {
        await render(() => {
          function Test2() {
  ...
  it.skip('resets state when switching between different component types', async () => {
    if (__DEV__) {
      await act(async () => {
        await render(() => {
          function Test() {
