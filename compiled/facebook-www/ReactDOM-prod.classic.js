...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    ...
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$81.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$81.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$137 = newProps.memoizedState.cachePool.pool);
        cache$137 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
    ...
    case 19:
      ...
      cache$137 = currentResource.rendering;
      if (null === cache$137)
        if (newProps) cutOffTailIfNeeded(currentResource, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$137 = findFirstSuspended(current);
              if (null !== cache$137) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(currentResource, !1);
                current = cache$137.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$137)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
        ...
        currentResource.isBackwards
          ? ((cache$137.sibling = workInProgress.child),
            (workInProgress.child = cache$137))
          : ((current = currentResource.last),
            null !== current
              ? (current.sibling = cache$137)
              : (workInProgress.child = cache$137),
            (currentResource.last = cache$137));
      }
...
function commitSuspenseHydrationCallbacks(finishedRoot, finishedWork) {
  if (null === finishedWork.memoizedState) {
    var current$169 = finishedWork.alternate;
    if (
      null !== current$169 &&
      ((current$169 = current$169.memoizedState),
      null !== current$169 &&
        ((current$169 = current$169.dehydrated), null !== current$169))
    )
      try {
        retryIfBlockedOn(current$169);
        var hydrationCallbacks = finishedRoot.hydrationCallbacks;
        if (null !== hydrationCallbacks) {
          var onHydrated = hydrationCallbacks.onHydrated;
          onHydrated && onHydrated(current$169);
        }
      } catch (error) {
        captureCommitPhaseError(finishedWork, finishedWork.return, error);
      }
...
function recursivelyTraverseReappearLayoutEffects(
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    var current$183 = parentFiber.alternate,
    ...
    switch (finishedWork.tag) {
      ...
      case 1:
        ...
        current$183 = finishedWork.updateQueue;
        if (null !== current$183) {
          var hiddenCallbacks = current$183.shared.hiddenCallbacks;
          if (null !== hiddenCallbacks)
            for (
              current$183.shared.hiddenCallbacks = null, current$183 = 0;
              current$183 < hiddenCallbacks.length;
              current$183++
            )
              callCallback(hiddenCallbacks[current$183], finishedRoot);
        }
        includeWorkInProgressEffects &&
          flags & 64 &&
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    shouldFireAfterActiveInstanceBlur$209 &&
      ((_enabled = !0),
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    var root$210 = rootWithPendingPassiveEffects,
    ...
    try {
      ...
      (Internals.p = previousPriority),
        (ReactSharedInternals.T = prevTransition),
        releaseRootPooledCache(root$210, remainingLanes);
    }
  }
  return !1;
}
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1539 = "oninput" in document;
    if (!isSupported$jscomp$inline_1539) {
      var element$jscomp$inline_1540 = document.createElement("div");
      element$jscomp$inline_1540.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1539 =
        "function" === typeof element$jscomp$inline_1540.oninput;
    }
    JSCompiler_inline_result$jscomp$370 = isSupported$jscomp$inline_1539;
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$283 = getResourcesFromRoot(currentProps).hoistableStyles,
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    ...
    var root$309 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
  ...
  if ("function" === typeof callback) {
    var originalCallback$310 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$311);
      originalCallback$310.call(instance);
    };
  }
  var root$311 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  container._reactRootContainer = root$311;
  container[internalContainerInstanceKey] = root$311.current;
  listenToAllSupportedEvents(
    8 === container.nodeType ? container.parentNode : container
  );
  updateContainerSync(initialChildren, root$311, parentComponent, callback);
  flushSyncWork();
  return root$311;
}
