 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<77cef1d9997ef4cbca87b7c81b909f74>>
 */
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$76.lanes | child$76.childLanes),
          (subtreeFlags |= child$76.subtreeFlags & 65011712),
          (subtreeFlags |= child$76.flags & 65011712),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$75.subtreeFlags & 65011712),
          (subtreeFlags |= treeBaseDuration$75.flags & 65011712),
  ...
  switch (finishedWork.tag) {
    ...
    case 6:
      ...
      if (flags & 4) {
        ...
        try {
          (existingHiddenCallbacks.text = flags), (rootMutationContext = !0);
        } catch (error) {
          captureCommitPhaseError(finishedWork, finishedWork.return, error);
        }
      }
    ...
    case 22:
      ...
      var wasHidden = null !== current && null !== current.memoizedState,
        ...
        prevOffscreenDirectParentIsHidden$118 = offscreenDirectParentIsHidden;
      offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden || instance;
      offscreenDirectParentIsHidden =
        prevOffscreenDirectParentIsHidden$118 || instance;
      offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden || wasHidden;
      recursivelyTraverseMutationEffects(root, finishedWork, lanes);
      offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden;
      offscreenDirectParentIsHidden = prevOffscreenDirectParentIsHidden$118;
        ...
        a: for (root = null, lanes = finishedWork; ; ) {
          if (5 === lanes.tag) {
            if (null === root) {
              current = root = lanes;
              try {
                (existingHiddenCallbacks = current.stateNode),
                  instance
                    ? (existingHiddenCallbacks.isHidden = !0)
                    : (current.stateNode.isHidden = !1);
              } catch (error) {
            ...
            if (null === root) {
              current = lanes;
              try {
                (current.stateNode.isHidden = instance ? !0 : !1),
                  (rootMutationContext = !0);
              } catch (error) {
                captureCommitPhaseError(current, current.return, error);
              }
            }
          } else if (18 === lanes.tag) {
            if (null === root) {
              current = lanes;
              try {
                ...
                instance
                  ...
                  : shim$1(current.stateNode);
              } catch (error) {
                captureCommitPhaseError(current, current.return, error);
              }
            }
          } else if (
            ((22 !== lanes.tag && 23 !== lanes.tag) ||
              null === lanes.memoizedState ||
              lanes === finishedWork) &&
            null !== lanes.child
          ) {
            lanes.child.return = lanes;
            lanes = lanes.child;
            continue;
          }
          if (lanes === finishedWork) break a;
          for (; null === lanes.sibling; ) {
            if (null === lanes.return || lanes.return === finishedWork) break a;
            root === lanes && (root = null);
            lanes = lanes.return;
          }
          root === lanes && (root = null);
          lanes.sibling.return = lanes.return;
          lanes = lanes.sibling;
        }
      flags & 4 &&
        ((flags = finishedWork.updateQueue),
  ...
  if (flags & 2) {
    try {
      ...
      switch (hostParentFiber.tag) {
        ...
        case 3:
        case 4:
          var parent$110 = hostParentFiber.stateNode.containerInfo,
...
function requestUpdateLane() {
  ...
  var JSCompiler_inline_result =
    0 !== currentUpdatePriority ? currentUpdatePriority : 32;
...
var internals$jscomp$inline_1256 = {
  bundleType: 0,
...
exports.create = function (element, options) {
  ...
  "object" === typeof options &&
    ...
    !1 === isConcurrentOnly && (isConcurrent = options.unstable_isConcurrent),
