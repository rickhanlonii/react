 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<e0385c437590be436ad9679c4b557a50>>
 */
...
for (
  var i$jscomp$inline_1962 = 0;
  i$jscomp$inline_1962 < simpleEventPluginEvents.length;
  i$jscomp$inline_1962++
) {
  var eventName$jscomp$inline_1963 =
      simpleEventPluginEvents[i$jscomp$inline_1962],
    domEventName$jscomp$inline_1964 =
      eventName$jscomp$inline_1963.toLowerCase(),
    capitalizedEvent$jscomp$inline_1965 =
      eventName$jscomp$inline_1963[0].toUpperCase() +
      eventName$jscomp$inline_1963.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1964,
    "on" + capitalizedEvent$jscomp$inline_1965
  );
}
