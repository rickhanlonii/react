...
6. Run verification:
   ...
   **To verify Swift fixes end-to-end**, ask the team lead to rebuild via `npm run app:run`. Do NOT use `build_run_sim`, `build_sim`, or `launch_app_sim` MCP tools — they fail due to sandbox restrictions.
